...
const features = [
  {
    ...
    title: "Driver\nProfiles",
    description:
      "Career stats, win rates, podium rates, and season-by-season breakdowns for every driver.",
    index: "01",
  },
  {
    href: "/live",
    ...
    title: "Live\nTelemetry",
    description:
      "Speed, RPM, throttle, brake, and tyre data from any session in any season.",
    index: "02",
  },
  {
    href: "/compare",
    ...
    title: "Driver\nComparison",
    description:
      "Side-by-side career statistics and performance analysis across every season.",
    index: "03",
  },
  {
    href: "/calendar",
    ...
    title: "Race\nCalendar",
    description:
      "Full season schedule with live countdown, results, and circuit details.",
    index: "04",
  },
  {
    href: "/predict",
    ...
    title: "Race\nPrediction",
    description:
      "Statistical model predicting podium finishers using form, standings, circuit history, and qualifying pace.",
    index: "05",
  },
];
      ...
      >
        ...
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse at top left, rgba(225,6,0,0.07) 0%, transparent 60%)",
            opacity: hovered ? 1 : 0,
        ...
        >
          <span className="data-readout" style={{ fontSize: "0.6rem" }}>
            {feature.index}
          </span>
          <span
            style={{
